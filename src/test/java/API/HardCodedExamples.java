...
public class HardCodedExamples {
    ...
    String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2MjY2MTc5NjgsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTYyNjY2MTE2OCwidXNlcklkIjoiMjk1MCJ9.iGH2uQnyvb8V7DB33n33meINVmtZigMvJwZFQaS59zM";
    ...
    public void apostCreateEmployee() {
        ...
        response.then().assertThat().body("Employee.emp_firstname", equalTo("Emma"));
    ...
    public void bgetCreatedEmployee() {
        ...
        RequestSpecification preparedRequest = given().header("Authorization", token).header("Content-Type", "application/json").queryParam("employee_id", "23082A");
        ...
        boolean comparingEmpIDs = empID.contentEquals("23082A");
        ...
        Assert.assertTrue(firstName.contentEquals("Emma2"));
    ...
    public void cGetAllEmployees() {
        ...
        for(int i =0; i < count; i++) {
             ...
             */
            if(employeedIDs.contentEquals("23082A")) {

                /*
                 * printing out the employee ID
                 */
                System.out.println("Employee ID " + "23082A" + " is present in response body");
